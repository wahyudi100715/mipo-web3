 ...
 */
export const listX402Bundles = (options) => {
    return cdpApiClient({ url: `/v2/x402/discovery/bundles`, method: "GET" }, options);
};
/**
 ...
 */
export const getX402Bundle = (bundleSlug, options) => {
    return cdpApiClient({ url: `/v2/x402/discovery/bundles/${bundleSlug}`, method: "GET" }, options);
};
/**
