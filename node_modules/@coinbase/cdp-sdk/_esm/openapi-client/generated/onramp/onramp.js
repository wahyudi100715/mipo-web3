 ...
 */
export const initiateOnrampVerification = (initiateOnrampVerificationRequest, options) => {
    return cdpApiClient({
 ...
 */
export const submitOnrampVerification = (verificationId, submitOnrampVerificationRequest, options) => {
    return cdpApiClient({
 ...
 */
export const createOnrampSession = (onrampSessionRequest, options) => {
    return cdpApiClient({
