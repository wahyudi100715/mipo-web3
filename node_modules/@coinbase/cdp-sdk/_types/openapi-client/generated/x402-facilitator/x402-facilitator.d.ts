 ...
 */
import type { ListX402DiscoveryMerchantParams, ListX402DiscoveryResourcesParams, SearchX402ResourcesParams, SettleX402PaymentBody, VerifyX402PaymentBody, X402BundleResponse, X402BundlesResponse, X402DiscoveryMerchantResponse, X402DiscoveryResourcesResponse, X402McpRequest, X402McpResponse, X402SearchResourcesResponse, X402SettleResponseResponse, X402SupportedPaymentKindsResponseResponse, X402ValidateRequest, X402ValidateResponse, X402VerifyResponseResponse } from "../coinbaseDeveloperPlatformAPIs.schemas.js";
 ...
 */
export declare const listX402Bundles: (options?: SecondParameter<typeof cdpApiClient<X402BundlesResponse>>) => Promise<X402BundlesResponse>;
/**
 ...
 */
export declare const getX402Bundle: (bundleSlug: string, options?: SecondParameter<typeof cdpApiClient<X402BundleResponse>>) => Promise<X402BundleResponse>;
/**
 ...
 */
export declare const validateX402Resource: (x402ValidateRequest: X402ValidateRequest, options?: SecondParameter<typeof cdpApiClient<X402ValidateResponse>>) => Promise<X402ValidateResponse>;
...
export type ValidateX402ResourceResult = NonNullable<Awaited<ReturnType<typeof validateX402Resource>>>;
export {};
