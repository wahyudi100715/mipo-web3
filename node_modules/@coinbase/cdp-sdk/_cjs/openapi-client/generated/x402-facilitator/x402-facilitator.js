...
exports.validateX402Resource = exports.getX402Bundle = exports.listX402Bundles = exports.postX402DiscoveryMcp = exports.searchX402Resources = exports.listX402DiscoveryMerchant = exports.listX402DiscoveryResources = exports.supportedX402PaymentKinds = exports.settleX402Payment = exports.verifyX402Payment = void 0;
 ...
 */
const listX402Bundles = (options) => {
    return (0, cdpApiClient_js_1.cdpApiClient)({ url: `/v2/x402/discovery/bundles`, method: "GET" }, options);
};
exports.listX402Bundles = listX402Bundles;
/**
 ...
 */
const getX402Bundle = (bundleSlug, options) => {
    return (0, cdpApiClient_js_1.cdpApiClient)({ url: `/v2/x402/discovery/bundles/${bundleSlug}`, method: "GET" }, options);
};
exports.getX402Bundle = getX402Bundle;
/**
