 ...
 */
export declare function uint8ArrayToMnemonic(uint8Array: Uint8Array): string;
/**
 ...
 */
export declare function convertMnemonicToWordlistIndices(mnemonic: string): Uint8Array;
