...
async function resolveRequestChainId(request, store) {
    ...
    const chainId_multisig = await (async () => {
        ...
        if (request.method === 'multisig_approveKeyAuthorization' &&
            ...
            try {
                return parseChainId(KeyAuthorization.fromRpc(value.keyAuthorization).chainId);
            }
            catch {
                return undefined;
            }
        ...
        return parseChainId(KeyAuthorization.deserialize(operation.keyAuthorization).chainId);
    })();
