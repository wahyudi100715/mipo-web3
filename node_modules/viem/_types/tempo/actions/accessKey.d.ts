...
import { KeyAuthorization, MultisigOperation, SignatureEnvelope } from 'ox/tempo';
...
import type { AccessKeyAccount, MultisigAccount, RootAccount } from '../Account.js';
import { resolveAccessKey, signKeyAuthorization } from '../Account.js';
 ...
 */
export declare function signAuthorization<chain extends Chain | undefined, account extends Account | undefined>(client: Client<Transport, chain, account>, parameters: signAuthorization.CoordinatedParameters): Promise<signAuthorization.CoordinatedReturnValue>;
export declare function signAuthorization<chain extends Chain | undefined, account extends Account | undefined>(client: Client<Transport, chain, account>, parameters: signAuthorization.LocalParameters<account>): Promise<signAuthorization.ReturnValue>;
export declare namespace signAuthorization {
    /** Initial coordinated key authorization parameters. */
    type CoordinatedInitialParameters = Omit<prepareAuthorization.Parameters<Account>, 'account' | 'multisig'> & {
    ...
    type CoordinatedParameters = OneOf<CoordinatedInitialParameters | {
    ...
    type LocalParameters<account extends Account | undefined = Account | undefined> = prepareAuthorization.Parameters<account> & {
    ...
    type Parameters<account extends Account | undefined = Account | undefined> = CoordinatedParameters | LocalParameters<account>;
    ...
    type CoordinatedReturnValue = Compute<ReturnValue & {
