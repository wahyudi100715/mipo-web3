...
import { type AuthorizationTempo, type KeyAuthorization, type MultisigOperation, type MultisigSimulation, type TransactionReceipt as ox_TransactionReceipt, SignatureEnvelope, type TempoAddress, TxEnvelopeTempo as TxTempo } from 'ox/tempo';
...
export type TransactionReceipt<quantity = bigint, index = number, status = 'success' | 'reverted' | 'pending', type = TransactionType, multisig = MultisigOperation.TransactionOperation> = viem_TransactionReceipt<quantity, index, status, type> & {
    feePayer?: Address | undefined;
    feeToken?: Address | undefined;
    multisig?: multisig | undefined;
};
export type TransactionReceiptRpc = TransactionReceipt<Hex.Hex, Hex.Hex, ox_TransactionReceipt.RpcStatus | 'pending', ox_TransactionReceipt.RpcType, MultisigOperation.TransactionRpc>;
