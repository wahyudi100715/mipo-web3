 ...
 */
export declare function fromMultisig(value: fromMultisig.InitialConfig): MultisigAccount<MultisigConfig.Config>;
export declare function fromMultisig(value: fromMultisig.CurrentConfig): MultisigAccount<MultisigConfig.Config>;
...
export declare namespace fromMultisig {
    ...
    type Parameters = Address.Address | CurrentConfig | InitialConfig;
}
export type MultisigAccount<config extends MultisigConfig.Config | undefined = MultisigConfig.Config | undefined> = RequiredBy<LocalAccount<'multisig'>, 'sign'> & {
