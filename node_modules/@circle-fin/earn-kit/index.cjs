 ...
 */ class EarnKit {
   ...
   */ async getVaults(params) {
        const result = await withErrorTelemetry(async ()=>getVaults(this.context, params), EARN_EVENT_TYPES.GET_VAULTS, this.telemetryConfig);
   ...
   */ async exploreVaults(params) {
        ...
        const result = await withErrorTelemetry(async ()=>exploreVaults(this.context, params), EARN_EVENT_TYPES.EXPLORE_VAULTS, this.telemetryConfig, context);
   ...
   */ async getPosition(params) {
        return withErrorTelemetry(async ()=>getPosition(this.context, params), EARN_EVENT_TYPES.GET_POSITION, this.telemetryConfig, {
   ...
   */ async getCrossChainDepositStatus(params) {
        return withErrorTelemetry(async ()=>getCrossChainDepositStatus(this.context, params), EARN_EVENT_TYPES.GET_CROSS_CHAIN_DEPOSIT_STATUS, this.telemetryConfig);
    }
    /**
   ...
   */ async waitForCrossChainDeposit(params) {
        return withErrorTelemetry(async ()=>waitForCrossChainDeposit(this.context, params), EARN_EVENT_TYPES.WAIT_FOR_CROSS_CHAIN_DEPOSIT, this.telemetryConfig);
    }
    async deposit(params) {
        ...
        const result = await withErrorTelemetry(async ()=>deposit(this.context, params), eventType, this.telemetryConfig, context);
   ...
   */ async withdraw(params) {
        ...
        const result = await withErrorTelemetry(async ()=>withdraw(this.context, params), EARN_EVENT_TYPES.WITHDRAW, this.telemetryConfig, context);
   ...
   */ async claimRewards(params) {
        ...
        const result = await withErrorTelemetry(async ()=>claimRewards(this.context, params), EARN_EVENT_TYPES.CLAIM_REWARDS, this.telemetryConfig, context);
        if (result.status === 'claimed') {
   ...
   */ async getDepositQuote(params) {
        return withErrorTelemetry(async ()=>getDepositQuote(this.context, params), EARN_EVENT_TYPES.GET_DEPOSIT_QUOTE, this.telemetryConfig, {
            sourceChain: resolveChainName(params.from.chain)
        });
    }
    /**
   ...
   */ async getWithdrawalQuote(params) {
        return withErrorTelemetry(async ()=>getWithdrawalQuote(this.context, params), EARN_EVENT_TYPES.GET_WITHDRAWAL_QUOTE, this.telemetryConfig, {
            sourceChain: resolveChainName(params.from.chain)
        });
    }
    /**
   ...
   */ async getClaimRewardsQuote(params) {
        return withErrorTelemetry(async ()=>getClaimRewardsQuote(this.context, params), EARN_EVENT_TYPES.GET_CLAIM_REWARDS_QUOTE, this.telemetryConfig, {
            sourceChain: resolveChainName(params.from.chain)
        });
    }
}
...
exports.EARN_EXECUTE_REVIEW_KIND = providerEarnService.EARN_EXECUTE_REVIEW_KIND;
...
exports.isEarnExecuteReview = providerEarnService.isEarnExecuteReview;
