...
function resolveFeePayoutChain(tokenIn, tokenOut, sourceChain, destinationChain) {
    ...
    const inputIsOk = isOkToken(tokenIn, sourceChain, TOKEN_REGISTRY$3, OK_TOKEN_SYMBOLS);
    if (inputIsOk) {
        return sourceChain;
    }
    const outputIsOk = isOkToken(tokenOut, destinationChain, TOKEN_REGISTRY$3, OK_TOKEN_SYMBOLS);
...
export { CREDENTIAL_CONFIG_FIELDS, StablecoinServiceSwapProvider };
