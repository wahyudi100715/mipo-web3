...
_Native USDC bridging across 52 chains using Circle's battle-tested protocols._
...
The CCTPv2 Bridging Provider is a strongly-typed implementation of Circle's Cross-Chain Transfer Protocol (CCTP) version 2 that enables **native USDC bridging** between 49 supported blockchain networks.
...
- **⚡ 51 chain support**: Enables bridging across all CCTPv2-supported networks
...
- ✅ **Multi-chain support** - Works across all 52 CCTPv2-supported chains
...
The provider supports **1300 total bridge routes** across these chains:
