 ...
 */ function padAddressToBytes32(address$1) {
    if (!address.isAddress(address$1)) {
        throw createValidationFailedError('address', address$1, 'Expected a valid 20-byte EVM address');
    }
 ...
 */ function assertAddress(address$1, field) {
    if (!address.isAddress(address$1)) {
        throw createValidationFailedError(field, address$1, 'Expected a valid EVM address');
    }
...
exports.getForwarderHookData = getForwarderHookData;
