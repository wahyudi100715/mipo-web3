 ...
 * ```
 */
declare const getForwarderHookData: (
/** The destination blockchain type - determines the hookData shape */
chainType: ChainType, 
/** The recipient's wallet address (hex for EVM, base58 for Solana) */
