...
/** Gas units consumed by the Gateway wallet `deposit` call on an EVM chain. */
declare const STANDARD_DEPOSIT_GAS_EVM = 80063n;
/** Compute units consumed by the Gateway wallet `deposit` call on a Solana chain. */
declare const STANDARD_DEPOSIT_GAS_SOLANA = 28908n;
/**
 ...
 * ```
 */
declare function estimateDepositGas<TAdapterCapabilities extends AdapterCapabilities = AdapterCapabilities>(params: {
    /** Source-chain adapter for gas estimation. */
    adapter: Adapter<TAdapterCapabilities>;
    /** Source chain definition. */
    srcChain: ChainDefinition;
 ...
 * ```
 */
declare function spend<TFromAdapterCapabilities extends AdapterCapabilities = AdapterCapabilities, TToAdapterCapabilities extends AdapterCapabilities = AdapterCapabilities>(params: SpendParams<TFromAdapterCapabilities, TToAdapterCapabilities>, dispatcher?: Actionable<GatewayV1Actions> | null, options?: SpendOptions): Promise<SpendResult>;
/**
 ...
 * ```
 */
declare function estimateSpend<TFromAdapterCapabilities extends AdapterCapabilities = AdapterCapabilities, TToAdapterCapabilities extends AdapterCapabilities = AdapterCapabilities>(params: SpendParams<TFromAdapterCapabilities, TToAdapterCapabilities>, requestConfig?: Partial<ApiPollingConfig>): Promise<EstimateSpendResult>;
 ...
 * ```
 */
declare function getDelegateStatus<TAdapterCapabilities extends AdapterCapabilities = AdapterCapabilities>(params: GetDelegateStatusParams<TAdapterCapabilities>, requestConfig?: Partial<ApiPollingConfig>): Promise<DelegateStatus>;
...
/**
 * Configuration options for the Gateway v1 provider.
 *
 * @remarks
 * Passed to {@link createGatewayV1Provider}. All fields are optional; an
 * empty config (or none) yields the default provider behaviour.
 */
interface GatewayV1Config {
    /**
     * Custom HTTP headers sent with every Circle Gateway API request the
     * provider makes (`/v1/info`, `/v1/balances`, `/v1/deposits`,
     * `/v1/estimate`, `/v1/transfer`, and forwarder status polling).
     *
     * @remarks
     * Headers are merged on top of the SDK defaults (such as `Content-Type`
     * and the SDK user-agent) rather than replacing them. Each header is
     * forwarded as-is to Circle's API; the SDK does not interpret it.
     *
     * @example
     * ```typescript
...
interface IGatewayProvider<TProviderActions = GatewayV1Actions> {
     ...
     * ```
     */
    spend<TFromAdapterCapabilities extends AdapterCapabilities = AdapterCapabilities, TToAdapterCapabilities extends AdapterCapabilities = AdapterCapabilities>(params: SpendParams<TFromAdapterCapabilities, TToAdapterCapabilities>, options?: SpendOptions): Promise<SpendResult>;
    /**
 ...
 * ```
 */
declare function createGatewayV1Provider(config?: GatewayV1Config): IGatewayProvider;
