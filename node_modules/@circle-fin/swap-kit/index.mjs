 ...
 */ z.object({
    ...
    types: z.record(z.string().min(1, 'Type name cannot be empty.'), z.array(typedDataFieldSchema, {
...
export { Blockchain, KitError, SwapChain, SwapKit, assertCustomFeePolicy, assertSwapParams, createSwapKitContext, customFeePolicySchema, estimate, getChainByEnum, getErrorCode, getErrorMessage, getSupportedChains, getSwapStatus, getTokenRates, isFatalError, isInputError, isKitError, isRetryableError$1 as isRetryableError, removeCustomFeePolicy, resolveSwapParams, setCustomFeePolicy, setExternalPrefix, swap, swapParamsSchema, waitForSwap };
