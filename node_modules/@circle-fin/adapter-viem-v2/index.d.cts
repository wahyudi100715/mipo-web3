...
interface BatchExecuteOptions {
    ...
    /**
     * Whether every call must execute atomically.
     *
     * EIP-5792 defaults to non-atomic execution, so this defaults to `true` to
     * preserve the adapter's atomic-batch contract.
     *
     * @defaultValue true
     */
...
declare class ViemAdapter<TAdapterCapabilities extends AdapterCapabilities = AdapterCapabilities> extends EvmAdapter<TAdapterCapabilities> {
     ...
     * ```
     */
    read(input: EvmPreparedChainRequestParams, meta: {
        chain: ChainIdentifier;
    }): Promise<unknown>;
    /**
