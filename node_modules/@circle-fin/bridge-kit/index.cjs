...
var zod = require('zod');
var providerCctpx = require('@circle-fin/provider-cctpx');
 ...
 */ const bridgeTokenSchema = zod.z.union([
    zod.z.enum([
        'USDC',
        ...providerCctpx.KNOWN_TOKEN_SYMBOLS
    ]),
 ...
 */ const getDefaultProviders = (config = {})=>[
        new providerCctpV2.CCTPV2BridgingProvider(config.headers ? {
            headers: config.headers
        } : {}),
        new providerCctpx.CCTPXBridgingProvider(config.headers ? {
            headers: config.headers
        } : {})
    ];
 ...
 */ class BridgeKit {
   ...
   */ findSourceFeeProvider(params) {
        ...
        for (const candidate of this.providers){
            if (candidate instanceof providerCctpV2.CCTPV2BridgingProvider && candidate.supportsRoute(params.source.chain, params.destination.chain, params.token, true)) {
                return candidate;
            }
        }
        throw createUnsupportedRouteError(params.source.chain.name, params.destination.chain.name);
...
exports.CCTPXBridgingProvider = providerCctpx.CCTPXBridgingProvider;
exports.KNOWN_TOKEN_SYMBOLS = providerCctpx.KNOWN_TOKEN_SYMBOLS;
...
exports.PlasmaTestnet = PlasmaTestnet;
exports.Plume = Plume;
exports.PlumeTestnet = PlumeTestnet;
exports.Polygon = Polygon;
exports.PolygonAmoy = PolygonAmoy;
exports.QUOTE_NOT_REUSED_WARNING_CODE = QUOTE_NOT_REUSED_WARNING_CODE;
exports.RateLimitError = RateLimitError;
exports.RpcError = RpcError;
exports.SPEED_DOWNGRADED_WARNING_CODE = SPEED_DOWNGRADED_WARNING_CODE;
exports.Sei = Sei;
