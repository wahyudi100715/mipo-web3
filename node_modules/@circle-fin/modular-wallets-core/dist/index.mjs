...
var ContractAddress = /* @__PURE__ */ ((ContractAddress2) => {
  ...
  ContractAddress2["Arc_USDC"] = "0x3600000000000000000000000000000000000000";
  ContractAddress2["ArcTestnet_USDC"] = "0x3600000000000000000000000000000000000000";
  ContractAddress2["Avalanche_USDC"] = "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E";
  ContractAddress2["AvalancheFuji_USDC"] = "0x5425890298aed601595a70AB815c96711a31Bc65";
  ...
  ContractAddress2["Monad_USDC"] = "0x754704bc059f8c67012fed69bc8a327a5aafb603";
  ContractAddress2["MonadTestnet_USDC"] = "0x534b2f3A21130d7a60830c2Df862319e593943A3";
...
var EIP1193Provider = class extends BaseProvider {
  ...
  async request(payload) {
    ...
    switch (method) {
      ...
      case "eth_signTypedData_v4": {
        const [address, typedDataParam] = params;
        await this.validateAddress(address);
        let typedData;
  ...
  async validateAddress(address) {
    ...
    if (!isAddress(address, { strict: false }) || !isAddressEqual(clientAddress, address)) {
...
// src/utils/rpc/isChromeExtension.ts
...
async function fetchFromApi(clientUrl, clientKey, payload, requestOptions) {
  ...
  const fetchResponse = await fetch(clientUrl, {
    ...
    headers: {
      ...
      "X-AppInfo": `platform=web;version=${"1.0.16"};uri=${uri}`
    },
    body: JSON.stringify({
      ...payload,
      jsonrpc: "2.0",
...
// src/utils/rpc/webAuthnHelpers.ts
function adaptCredentialCreationOptions(options) {
...
function adaptCredentialRequestOptions(options) {
  if (isChromeExtension()) {
...
var webAuthnSign = async ({
  ...
  if (challengeIndex === void 0 || typeIndex === void 0) {
    throw new Error(
