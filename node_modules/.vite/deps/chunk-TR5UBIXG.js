...
import {
  ...
  call_exports,
  mini_exports
} from "./chunk-VTWJ6U5J.js";
import {
  ChainNotConfiguredError,
  ProviderNotFoundError,
  createConnector,
  extractRpcUrls
} from "./chunk-RDH7O676.js";
import {
  arbitrum,
  arbitrumSepolia,
  base,
  ...
  polygonAmoy,
  sepolia
} from "./chunk-N2DGGHTO.js";
import {
  withRetry,
  withTimeout
} from "./chunk-LQWRGYFB.js";
import {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-MRSOFN6Y.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-IHVDNSQU.js");
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-IDHSRUN4.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-S3XM5EV4.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-LCT7FSND.js");
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TR5UBIXG.js.map
