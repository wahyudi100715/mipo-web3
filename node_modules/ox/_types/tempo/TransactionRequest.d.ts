...
export type Rpc = Omit<TransactionRequest<Hex.Hex, Hex.Hex, string, Hex.Hex>, 'authorizationList' | 'feeToken' | 'keyAuthorization' | 'multisigSimulation'> & {
...
export declare namespace fromRpc {
    type ErrorType = AuthorizationTempo.fromRpcList.ErrorType | Hex.toBigInt.ErrorType | Hex.toNumber.ErrorType | MultisigSimulation.fromRpc.ErrorType | Errors.GlobalErrorType;
}
/**
...
export declare namespace toRpc {
    type ErrorType = AuthorizationTempo.toRpcList.ErrorType | MultisigSimulation.toRpc.ErrorType | Hex.fromNumber.ErrorType | Errors.GlobalErrorType;
}
export {};
