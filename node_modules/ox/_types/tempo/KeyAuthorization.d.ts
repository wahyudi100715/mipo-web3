...
export type SignatureRpc = SignatureEnvelope.MultisigRpc | SignatureEnvelope.PrimitiveRpc;
...
type SignatureValue = UnionPartialBy<Signature, 'prehash' | 'type'> | SignatureEnvelope.Secp256k1Flat | SignatureEnvelope.Serialized | SignatureEnvelope.from.MultisigFromConfig;
