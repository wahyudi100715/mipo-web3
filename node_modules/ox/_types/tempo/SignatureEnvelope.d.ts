...
type EnvelopeOneOf<union extends object, keys extends PropertyKey> = union extends union ? Compute<union & {
    [key in Exclude<keys, keyof union>]?: undefined;
}> : never;
type SignatureEnvelopeKey = 'account' | 'config' | 'inner' | 'keyId' | 'metadata' | 'prehash' | 'publicKey' | 'signature' | 'signatures' | 'type' | 'userAddress' | 'version';
type SignatureEnvelopeRpcKey = 'keyId' | 'metadata' | 'preHash' | 'pubKeyX' | 'pubKeyY' | 'r' | 's' | 'signature' | 'type' | 'userAddress' | 'v' | 'version' | 'webauthnData' | 'yParity';
 ...
 */
export type SignatureEnvelope<bigintType = bigint, numberType = number> = EnvelopeOneOf<Secp256k1<bigintType, numberType> | P256<bigintType, numberType> | WebAuthn<bigintType, numberType> | Keychain<bigintType, numberType>, SignatureEnvelopeKey> | MultisigOneOf<bigintType, numberType>;
/**
 * RPC-formatted signature envelope.
 */
export type SignatureEnvelopeRpc = EnvelopeOneOf<Secp256k1Rpc | P256Rpc | WebAuthnRpc | KeychainRpc, SignatureEnvelopeRpcKey> | MultisigRpc;
...
type MultisigOneOf<bigintType = bigint, numberType = number> = Multisig<bigintType, numberType> & {
    inner?: undefined;
    keyId?: undefined;
    metadata?: undefined;
    prehash?: undefined;
...
export declare namespace from {
    ...
    type Value = UnionPartialBy<SignatureEnvelope, 'prehash' | 'type'> | Secp256k1Flat | Serialized | MultisigFromConfig;
    type ReturnValue<value extends Value> = value extends Serialized ? SignatureEnvelope : value extends Secp256k1Flat ? Secp256k1 : value extends MultisigFromConfig ? MultisigOneOf : IsNarrowable<value, SignatureEnvelope> extends true ? SignatureEnvelope : Assign<value, {
...
export declare namespace fromRpc {
    type ErrorType = assert.ErrorType | CoercionError | Hex.concat.ErrorType | Hex.isEqual.ErrorType | InvalidSerializedError | serialize.ErrorType | Signature.fromRpc.ErrorType | Errors.GlobalErrorType;
}
/**
...
export declare namespace toRpc {
    ...
    type ErrorType = assert.ErrorType | CoercionError | Hex.fromNumber.ErrorType | Hex.slice.ErrorType | serialize.ErrorType | Signature.toRpc.ErrorType | Errors.GlobalErrorType;
}
/**
